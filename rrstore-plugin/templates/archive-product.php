...
<div class="products-page-container">
    ...
    <div class="products-container relative">
        ...
        ?>
                <div class="product-card" id="<?php echo $post_slug . '_card'; ?>">
                    <div class="product-card-details" id="<?php echo $post_slug . '_details'; ?>">
                        ...
                        <div class="product-card-image">
                            ...
                            if (!$img):
                            ?>
                                <img src="<?php echo site_url() ?>/wp-content/plugins/rrstore plugin/rrstore-plugin/images/sample-product.png" class="product-card-image" id="<?php echo $post_slug . '_img'; ?>" />
                            <?php
                            else :
                            ?>
                    ...
                    <div class="product-card-actions-container">
                        <button class="product-card-actions-details" id="<?php echo $post_slug . '_info'; ?>">Info</Button>
