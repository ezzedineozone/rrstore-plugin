...
<div class = "header">
    ...
    <div class = "navigation-container">
        ...
        <div class = "custom-navigation-container">
            ...
            <form id = "main-search-form" method = "POST" class = "border-yellow-custom border-4 w-auto h-auto flex text-sm rounded-sm space-x-2">
                    <input name = "search_query" class = "rounded-sm text-base bg-white h-8 p-2 space-x-2" placeholder = "Search..." />
                    <button type="submit" class = "bg-blue-800 rounded-sm text-white w-10 h-auto flex items-center justify-center">
                        <svg class="w-6 h-6 text-white dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
